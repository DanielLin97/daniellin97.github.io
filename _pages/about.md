...
<section class="scholar-hero" aria-labelledby="hero-title">
  <div class="scholar-hero__texture" aria-hidden="true"></div>
  <div class="scholar-hero__copy">
    ...
    <p class="scholar-hero__thesis">Building trustworthy intelligent systems that reason across language, vision, and social context.</p>
    ...
    <ul class="scholar-topics" aria-label="Research interests">
...
<section class="scholar-section scholar-about" id="about" aria-labelledby="about-title">
  <div class="scholar-section__heading scholar-about__heading">
    <p class="scholar-index">01 / Biography</p>
    <h2 id="about-title">About me</h2>
    <p>A research journey shaped by trustworthy AI, multimodal understanding, and the study of online communities.</p>
  </div>
  <div class="scholar-about__body">
    <p>I am Hongzhan Lin (<span lang="zh">林鸿展</span>), a Research Fellow at the <a href="https://ctic.nus.edu.sg">Centre for Trusted Internet and Community (CTIC)</a>, National University of Singapore. I work closely with <a href="https://www.comp.nus.edu.sg/~leeml/">Prof. Mong-Li Lee</a>, <a href="https://www.comp.nus.edu.sg/~whsu/">Prof. Wynne Hsu</a>, and <a href="https://www.comp.nus.edu.sg/~chuats/">Prof. Tat-Seng Chua</a>.</p>
...
<section class="scholar-section scholar-section--research" id="research" aria-labelledby="research-title">
  <div class="scholar-section__heading">
    <p class="scholar-index">02 / Research</p>
    <h2 id="research-title">Questions that guide my work</h2>
    <p>I study how intelligent systems can become more reliable, interpretable, and socially aware, especially when language and visual evidence interact.</p>
  </div>
  <div class="research-grid">
    <article class="research-card">
      <span class="research-card__number">A</span>
    ...
    <article class="research-card">
      <span class="research-card__number">B</span>
    ...
    <article class="research-card">
      <span class="research-card__number">C</span>
...
<aside class="scholar-callout" aria-labelledby="collaboration-title">
  <div>
    <p class="scholar-index">Open call</p>
    <h2 id="collaboration-title">Ideas travel further in good company.</h2>
  </div>
...
<section class="scholar-service" id="service" aria-labelledby="service-title">
  <div class="scholar-service__intro">
    <p class="scholar-index">05 / Academic citizenship</p>
    <h2 id="service-title">Professional service</h2>
    <p>Contributing to the research community through conference organization, area chairing, and peer review.</p>
  </div>
